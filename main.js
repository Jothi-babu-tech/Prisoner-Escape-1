...
const canvas = document.querySelector('#glcanvas');
  ...
  const texturecoins = loadTexture(gl, 'coins.png');
  const texturejetpack = loadTexture(gl, 'nimbus.png');
  const texturespeedpower = loadTexture(gl, 'speed.png');
  const textureboots = loadTexture(gl, 'boots.png');
